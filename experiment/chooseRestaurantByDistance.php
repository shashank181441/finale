...
<body onload :getLocation()>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col col-6 col-md-4 col-xs-2"></div>
            <div class="col col-3">
        ...
        ?>
        <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">Distance</button>
  <ul class="dropdown-menu">
    <li><a class="dropdown-item" href="chooseRestaurant.php">Popularity</a></li>
  </ul>
</div>
        <div class="border-top">
            <div class="row m-3 d-flex justify-content-center">
                ...
                $sf = 3.14159 / 180; // scaling factor
                    ...
                    $sql = "SELECT *,(sqrt((pow((lattitude-$lat),2)+(pow((longitude-$long),2)))))/0.0115165 AS distance FROM add_rest where CONCAT(rest_name) LIKE '%$filtervalues%' ORDER BY distance";
                ...
                ?>
                        <div class="col col-4 col-md-4 col-sm-4 text-left mx-5 my-3 text-center" style="height: 200px; width:auto;">
